...
function generateServiceHTML (service) {
    return  `
    <div class="bg-white shadow-lg transform hover:scale-105 transition-all duration-300 cursor-pointer rounded-lg overflow-hidden">
    <div class="p-6 text-left">
    <img src="./images/service-icon.png" alt="service icon">
    <h3 class="text-2xl font-semibold my-4">${service.title}</h3>
    <p text-gray-700 mb-4>${service.description}</p>
    </div>
    </div>
    `
} 
